const fields = [
	{ type: 0, label: 'Статус' },
	{ type: 0, label: 'Рег. номер' },
	{ type: 0, label: 'Дата регистрации' },
	{ type: 1, label: 'Автор' },
	{ type: 1, label: 'Исполнитель' },
	{ type: 1, label: 'Контролер' },
	{ type: 1, label: 'Подготовил' },
	...
	{ type: 0, label: 'Основные файлы' },
	{ type: 0, label: 'Дополнительные файлы' },
	{ type: 1, label: 'Подпись' },
]
