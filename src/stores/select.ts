...
const conditions = [
	...
	{ type: 0, kind: ['date'], value: 'Сегодня', label: 'Сегодня' },
	{ type: 0, kind: ['date'], value: 'Сейчас', label: 'Сейчас' },
	{ type: 0, kind: ['date'], value: 'Текущая неделя', label: 'Текущая неделя' },
	{ type: 0, kind: ['date'], value: 'Текущий месяц', label: 'Текущий месяц' },
	{ type: 0, kind: ['date'], value: 'Текущий квартал', label: 'Текущий квартал' },
	{ type: 0, kind: ['date'], value: 'Текущий год', label: 'Текущий год' },
