const fields = [
	...
	{ type: 2, kind: ['doc', 'dog'], value: 'Дата регистрации', label: 'Дата регистрации' },
	{ type: 2, kind: ['doc', 'task', 'dog'], value: 'Создано', label: 'Создано' },
	{ type: 2, kind: ['doc', 'task', 'dog'], value: 'Изменено', label: 'Изменено' },
	...
	{ type: 2, kind: ['task'], value: 'Срок исполнения', label: 'Срок исполнения' },
